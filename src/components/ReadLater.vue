...
margin-left:auto;
 ...
 font-size: 2.2em;
 line-height: 1.25em;">Hey {{first_name}}! your Read later section</h2>
...
<div v-for="(obj,index) in object" :key="index">
 ...
 border-radius: 10px; padding:50px 0 50px 0;">
    <div class="card-body">
      <p class="logo" @click="viewprofile" style="margin-left: auto;margin-right: 90%; width:80px;height:auto;padding-bottom: 5px;"><img src="../assets/default.jpg" alt=""></p>
 ...
 border: 1px solid rgba(58, 55, 55, 0.3);" @click="unfollow(obj.author.id)" v-if="obj.following && obj.author.id != this.id" name="myButton">Following <i class="fa fa-check" aria-hidden="true"></i></button>
...
export default {
  ...
  beforeCreate() {
    axios.get('http://blogify-webapp.herokuapp.com/api/blog/getreadlater/', {
      headers: {
